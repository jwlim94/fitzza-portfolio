...
export default function Home() {
  ...
  const [isInstagramClicked, setIsInstagramClicked] = useState<boolean | null>(null);
  const [isGithubClicked, setIsGithubClicked] = useState<boolean | null>(null);
  const [isLinkedinClicked, setIsLinkedinClicked] = useState<boolean | null>(true);
  ...
  const features = [
    ...
    {
      id: "0", name: "About us", gif: "/gifs/test.gif", content: <div className="flex-grow flex flex-col items-center justify-center">
        ...
        {isGithubClicked && (
          <div>
            <div className="flex bg-gray-200 h-12 mt-7 px-4 gap-x-4 rounded-full z-10">
              <div className="self-center">
                <Link
                  href="https://www.github.com/jwlim94"
                  target="_blank"
                >
                  <Image
                    className="rounded-full"
              ...
              <div className="self-center">
                <Link
                  href="https://www.github.com/sjpsean"
                  target="_blank"
                >
                  <Image
                    className="rounded-full hover:scale-110"
    ...
    {
      id: "1", name: "Verify", gif: "/gifs/verify.gif", content: <Image
        src="/gifs/verify.gif"
        alt="Verify GIF"
        width={0}
        height={0}
    ...
    {
      id: "2", name: "Register", gif: "/gifs/register.gif", content: <Image
    ...
    {
      id: "3", name: "Listings", gif: "/gifs/listings.gif", content: <Image
    ...
    {
      id: "4", name: "Neighbor", gif: "/gifs/neighbor.gif", content: <Image
    ...
    {
      id: "5", name: "Search", gif: "/gifs/search.gif", content: <Image
        src="/gifs/search.gif"
        alt="Search GIF"
        width={0}
        height={0}
    ...
    {
      id: "6", name: "Favorite", gif: "/gifs/favorite.gif", content: <Image
    ...
    {
      id: "7", name: "Chat", gif: "/gifs/chat.gif", content: <Image
        src="/gifs/chat.gif"
        alt="Chat GIF"
        width={0}
        height={0}
    ...
    {
      id: "8", name: "Profile", gif: "/gifs/profile.gif", content: <Image
    ...
    {
      id: "9", name: "Create", gif: "/gifs/create.gif", content: <Image
        src="/gifs/create.gif"
        alt="Create GIF"
        width={0}
        height={0}
    ...
    {
      id: "10", name: "🚧 Rewards", gif: "/images/not-ready.png", content: <Image
    ...
    {
      id: "11", name: "🚧 Admin", gif: "/images/not-ready.png", content: <Image
        src="/images/not-ready.png"
        alt="Not Ready"
        width={200}
        height={200}
    ...
    {
      id: "12", name: "🚧 Analytics", gif: "/images/not-ready.png", content: <Image
        src="/images/not-ready.png"
        alt="Not Ready"
        width={200}
        height={200}
  ...
  return isMobile ? (
    <div className="flex flex-col w-screen h-screen">
      <div className="flex justify-between items-center px-16 pt-6">
        {currentIndex !== 0 ? <div className="cursor-pointer text-xl p-6" onClick={() => {
          if (currentIndex === 0) return;
          setcurrentIndex(currentIndex - 1);
        }}>◀︎</div> : <div className="p-6" />}
        <div className="text-xl">
          {features[currentIndex].name}
        </div>
        {currentIndex !== features.length - 1 ? <div className="cursor-pointer text-xl p-6" onClick={() => {
      ...
      <div className="flex min-h-screen p-10">
        <div className="flex relative w-full justify-center items-center">
          ...
          <div className="grid w-32">
            {features.filter((feature) => feature.id !== "0").map((feature) => (
